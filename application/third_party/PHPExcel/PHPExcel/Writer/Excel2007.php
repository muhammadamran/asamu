        ...
        if ($this->spreadSheet !== null) {
            ...
            if ($this->spreadSheet->hasRibbon()) {
                ...
                if ($this->spreadSheet->hasRibbonBinObjects()) {
                    $tmpclientPath=dirname($tmpRibbonTarget).'/';
                    $ribbonBinObjects=$this->spreadSheet->getRibbonBinObjects('data');//the files to write
                    foreach ($ribbonBinObjects as $aPath => $aContent) {
                        $objZip->addFromString($tmpclientPath.$aPath, $aContent);
                    }
                    //the rels for files
                    $objZip->addFromString($tmpclientPath.'_rels/'.basename($tmpRibbonTarget).'.rels', $this->getWriterPart('RelsRibbonObjects')->writeRibbonRelationships($this->spreadSheet));
                }
            }
