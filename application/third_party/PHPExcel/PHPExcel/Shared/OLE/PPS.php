...
class PHPExcel_Shared_OLE_PPS
{
    ...
    */
    ...
    /**
    * The PPS type. Dir, client or File
    * @var integer
    */
    public $Type;
    ...
    */
    ...
    /**
    * The index of it's first child if this is a Dir or client PPS
    * @var integer
    */
    public $DirPps;
    ...
    */
    ...
    /**
    * Array of child PPS's (only used by client and Dir PPS's)
    * @var array
    */
    ...
    * @param integer $type The PPS type. Dir, client or File
    * @param integer $prev The index of the previous PPS
    * @param integer $next The index of the next PPS
    * @param integer $dir  The index of it's first child if this is a Dir or client PPS
    ...
    */
    public function _getPpsWk()
    {
        ...
        $ret .= pack("v", strlen($this->Name) + 2)  // 66
              ...
              . "\x00\x00\x00\x00"                  // 88
              . "\xc0\x00\x00\x00"                  // 92
              . "\x00\x00\x00\x46"                  // 96 // Seems to be ok only for client
              . "\x00\x00\x00\x00"                  // 100
    ...
    */
    public static function _savePpsSetPnt(&$raList, $to_save, $depth = 0)
    {
        if (!is_array($to_save) || (empty($to_save))) {
            ...
            $cnt = count($raList);
            // If the first entry, it's the client... Don't clone it!
