...
// +----------------------------------------------------------------------+
//
// $Id: client.php,v 1.9 2005/04/23 21:53:49 dufuz Exp $


/**
* Class for creating client PPS's for OLE containers
*
* @author   Xavier Noguer <xnoguer@php.net>
* @category PHPExcel
* @package  PHPExcel_Shared_OLE
*/
class PHPExcel_Shared_OLE_PPS_client extends PHPExcel_Shared_OLE_PPS
{
    ...
    public function __construct($time_1st, $time_2nd, $raChild)
    {
        ...
        parent::__construct(null, PHPExcel_Shared_OLE::Asc2Ucs('client Entry'), PHPExcel_Shared_OLE::OLE_PPS_TYPE_client, null, null, null, $time_1st, $time_2nd, null, $raChild);
    }
    ...
    */
    public function save($filename)
    {
        ...
        if (is_resource($filename)) {
            ...
            $this->_tmp_filename = tempnam($this->tempDirectory, "OLE_PPS_client");
    ...
    */
    public function _saveHeader($iSBDcnt, $iBBcnt, $iPPScnt)
    {
        ...
        fwrite(
            ...
            . "\x00\x00\x00\x00"
            . pack("V", $iBdCnt)
            . pack("V", $iBBcnt+$iSBDcnt) //client START
            . pack("V", 0)
            . pack("V", 0x1000)
    ...
    public function _saveBigData($iStBlk, &$raList)
    {
        ...
        for ($i = 0; $i < $iCount; ++$i) {
            if ($raList[$i]->Type != PHPExcel_Shared_OLE::OLE_PPS_TYPE_DIR) {
                $raList[$i]->Size = $raList[$i]->_DataLen();
                if (($raList[$i]->Size >= PHPExcel_Shared_OLE::OLE_DATA_SIZE_SMALL) || (($raList[$i]->Type == PHPExcel_Shared_OLE::OLE_PPS_TYPE_client) && isset($raList[$i]->_data))) {
                    // Write Data
        ...
        for ($i = 0; $i < $iCount; ++$i) {
            ...
            if ($raList[$i]->Type == PHPExcel_Shared_OLE::OLE_PPS_TYPE_FILE) {
                ...
                if ($raList[$i]->Size < PHPExcel_Shared_OLE::OLE_DATA_SIZE_SMALL) {
                    ...
                    //// Add to Data String(this will be written for clientEntry)
