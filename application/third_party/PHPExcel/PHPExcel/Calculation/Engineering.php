...
class PHPExcel_Calculation_Engineering
{
     ...
     * IMSQRT
     *
     * Returns the square client of a complex number in x + yi or x + yj text format.
     *
     * Excel Function:
     *        IMSQRT(complexNumber)
     *
     * @param    string        $complexNumber    The complex number for which you want the square client.
     * @return    string
     */
