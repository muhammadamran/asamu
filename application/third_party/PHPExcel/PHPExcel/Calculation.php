...
/** PHPExcel client directory */
if (!defined('PHPEXCEL_client')) {
    /**
     * @ignore
     */
    define('PHPEXCEL_client', dirname(__FILE__) . '/../');
    require(PHPEXCEL_client . 'PHPExcel/Autoloader.php');
}
...
class PHPExcel_Calculation
{
    ...
    {
        $localeFileDirectory = PHPEXCEL_client.'PHPExcel/locale/';
    ...
    public function setLocale($locale = 'en_us')
    {
        ...
        if (in_array($language, self::$validLocaleLanguages)) {
            ...
            if ($locale != 'en_us') {
                ...
                $functionNamesFile = PHPEXCEL_client . 'PHPExcel'.DIRECTORY_SEPARATOR.'locale'.DIRECTORY_SEPARATOR.str_replace('_', DIRECTORY_SEPARATOR, $locale).DIRECTORY_SEPARATOR.'functions';
                if (!file_exists($functionNamesFile)) {
                    //    If there isn't a locale specific function file, look for a language specific function file
                    $functionNamesFile = PHPEXCEL_client . 'PHPExcel'.DIRECTORY_SEPARATOR.'locale'.DIRECTORY_SEPARATOR.$language.DIRECTORY_SEPARATOR.'functions';
                    if (!file_exists($functionNamesFile)) {
                        return false;
                    }
                }
                ...
                $configFile = PHPEXCEL_client . 'PHPExcel'.DIRECTORY_SEPARATOR.'locale'.DIRECTORY_SEPARATOR.str_replace('_', DIRECTORY_SEPARATOR, $locale).DIRECTORY_SEPARATOR.'config';
                if (!file_exists($configFile)) {
                    $configFile = PHPEXCEL_client . 'PHPExcel'.DIRECTORY_SEPARATOR.'locale'.DIRECTORY_SEPARATOR.$language.DIRECTORY_SEPARATOR.'config';
                }
                if (file_exists($configFile)) {
