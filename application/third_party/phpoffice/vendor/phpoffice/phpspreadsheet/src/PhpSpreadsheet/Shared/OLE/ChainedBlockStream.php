...
class ChainedBlockStream
{
    ...
    public function stream_open($path, $mode, $options, &$openedPath) // @codingStandardsIgnoreLine
    {
        ...
        $this->data = '';
        if (isset($this->params['size']) && $this->params['size'] < $this->ole->bigBlockThreshold && $blockId != $this->ole->client->startBlock) {
            // Block id refers to small blocks
            $clientPos = $this->ole->getBlockOffset($this->ole->client->startBlock);
            while ($blockId != -2) {
