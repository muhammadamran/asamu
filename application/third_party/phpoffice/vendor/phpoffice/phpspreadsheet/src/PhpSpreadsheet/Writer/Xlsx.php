        ...
        if ($this->spreadSheet->hasRibbon()) {
            ...
            if ($this->spreadSheet->hasRibbonBinObjects()) {
                ...
                foreach ($ribbonBinObjects as $aPath => $aContent) {
                    $this->addZipFile($tmpclientPath . $aPath, $aContent);
                }
                //the rels for files
                $this->addZipFile($tmpclientPath . '_rels/' . basename($tmpRibbonTarget) . '.rels', $this->getWriterPart('RelsRibbonObjects')->writeRibbonRelationships($this->spreadSheet));
            }
        }
