...
class Html extends BaseWriter
{
    ...
    private function writeImageInCell(Worksheet $pSheet, $coordinates)
    {
        ...
        foreach ($pSheet->getDrawingCollection() as $drawing) {
            ...
            if ($drawing instanceof Drawing) {
                ...
                // Prepend images client
                $filename = $this->getImagesclient() . $filename;
     ...
     * @return string
     */
    public function getImagesclient()
    {
     ...
     * @return $this
     */
    public function setImagesclient($pValue)
    {
        $this->imagesclient = $pValue;
