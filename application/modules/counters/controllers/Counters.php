...
class Counters extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($user == NULL) {
            ...
            // DATA GALERI
            $get_data = $this->Counters_model->get_data_galeri();
            $value['data_galeri'] = $get_data;

            $this->load->view('include/head');
            $this->load->view('include/top-header');
            $this->load->view('include/alert');
            $this->load->view('counters', $value);
    ...
    public function updating()
    {
        ...
        $this->Counters_model->update_galeri('tbl_gallery', $dataGaleri, $ID);
        $this->session->set_flashdata('success', "Data saved successfully!");
        redirect('galeri');
    }
    ...
    public function delete()
    {
        ...
        $this->Counters_model->delete_galeri($where);
    ...
    public function nonaktif()
    {
        ...
        $this->Counters_model->update_galeri('tbl_gallery', $input_data, $ID);
