...
class Clients extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($user == NULL) {
            ...
            // DATA CLIENTS
            $get_data = $this->Clients_model->get_data_galeri();
    ...
    public function updating()
    {
        ...
        $this->Clients_model->update_galeri('tbl_gallery', $dataGaleri, $ID);
        $this->session->set_flashdata('success', "Data saved successfully!");
        redirect('galeri');
    }
    ...
    public function delete()
    {
        ...
        $this->Clients_model->delete_galeri($where);
    ...
    public function nonaktif()
    {
        ...
        $this->Clients_model->update_galeri('tbl_gallery', $input_data, $ID);
