...
class Galeri extends CI_Controller {
    ...
    public function index()
    {
        ...
        // DATA GALERI
            $get_data = $this->Galeri_model->get_data_galeri();
            $value['data_galeri'] = $get_data; 
            
            $this->load->view('include/head');
            $this->load->view('include/top-header');
            $this->load->view('include/alert');
            $this->load->view('galeri',$value);
    ...
    public function updating()
    {
        ...
        $this->Galeri_model->update_galeri('tbl_gallery', $dataGaleri,$ID);
        $this->session->set_flashdata('success', "Data saved successfully!");
        redirect('galeri');
    }
    ...
    public function delete()
	{
		...
		$this->Galeri_model->delete_galeri($where);
    ...
    public function nonaktif()
    {
        ...
        $this->Galeri_model->update_galeri('tbl_gallery', $input_data,$ID);
